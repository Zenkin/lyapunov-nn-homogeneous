...
The implementations were consolidated into `main` in [PR #13](https://github.com/Zenkin/lyapunov-nn-homogeneous/pull/13).
The three preceding branch tips form one ancestry chain:

| Branch | Commit | Contents |
| --- | --- | --- |
| `main` | [`8e64917`](https://github.com/Zenkin/lyapunov-nn-homogeneous/commit/8e6491778ef721765d1487d80a12b04475056afe) | Example 1 |
